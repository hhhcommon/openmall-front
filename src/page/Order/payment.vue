  ...
  <div class="w" style="padding-bottom: 100px;">
    ...
    <div class="p-msg w">
      <div class="confirm-detail">
        ...
        <p class="info-detail">详细地址：{{province}}-{{city}}-{{region}}-{{streetName}}</p>
      </div>
    </div>
    ...
    <div class="order-discount-line">
      <p style="font-size: 14px;font-weight: bolder;">
        ...
        <span style="font-size: 16px;font-weight: 500;line-height: 32px;">¥ {{order.totalAmount}}</span>
      </p>
      <p>
...
import { getOrderDet, payMent, getCartList } from "/api/goods";
...
export default {
  ...
  created() {
    // this._getCartList();
    let address = JSON.parse(getStore("adress"))
    ...
    this.tel = address.phoneNumber
    this.province = address.province
    this.city = address.city
    this.region = address.region
    this.streetName = address.detailAddress
