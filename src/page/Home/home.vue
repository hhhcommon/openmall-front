  ...
  <div class="home">
    ...
    <!-- <div class="good-container">
      ...
      <div class="goods-box w">
        <mall-goods v-for="(item,i) in hotProductList" :key="i" :msg="item" v-if="i<8"></mall-goods>
      </div>
    </div> -->
    <div></div>
    <div class="good-container">
      ...
      <div class="goods-box w">
        <mall-goods v-for="(item,i) in newProductList" :key="i" :msg="item" v-if="i<8"></mall-goods>
      </div>
    </div>
    <!-- <div class="good-container">
      <div class="good-title">
      ...
      <div class="goods-box w">
        <mall-goods v-for="(item,i) in goods.list2" :key="i" :msg="item" v-if="i<8"></mall-goods>
      </div>
    </div>-->
  </div>
</template>
<script>
import { homeContent } from "/api/index.js";
import YShelf from "/components/shelf";
import product from "/components/product";
import mallGoods from "/components/mallGoods";
import { setStore, getStore } from "/utils/storage.js";
import { mapMutations, mapState } from "vuex";
import {mixinsDom} from "../../mixins"
